...
public class JogoInteligentexInteligente extends Modo{
        ...
        while (true) { 
            ...
            try {
                if (robo1.mover(direcao1)) {
                    ...
                    System.out.print(robo1.getCor() + "Robô inteligente " + Main.RESET + "se move para: ");
                    switch(direcao1){
                        case 1:
                ...
                System.out.println("Erro no " + robo1.getCor() + "robô inteligente" + Main.RESET + ": " + Main.ERRO_COR + e.getMessage() + Main.RESET);
            }
            tabuleiro.mostrarTabuleiro(robo1, robo2, comida.getPosicao());
            delay();
            ...
            try {
                if (robo2.mover(direcao2)) {
                    ...
                    System.out.print(robo2.getCor() + "Robô normal " + Main.RESET + "se move para: ");
                    switch(direcao2){
                        case 1:
                            System.out.println("cima");
                            break;
                ...
                System.out.println("Erro no " + robo2.getCor() + "robô normal" + Main.RESET + ": " + Main.ERRO_COR + e.getMessage() + Main.RESET);
            }
            tabuleiro.mostrarTabuleiro(robo1, robo2, comida.getPosicao());
            delay();
            ...
            if (robo1.isComida(comida) || robo2.isComida(comida)) {
                if (robo1.isComida(comida)) {
                    System.out.println("Comida encontrada pelo " + robo1.getCor() + "robô inteligente!" + Main.RESET);
                } else {
                    System.out.println("Comida encontrada pelo " + robo2.getCor() + "robô normal!" + Main.RESET);
                }
                System.out.println("Movimentos do " + robo1.getCor() + "robô inteligente" + Main.RESET + ": " + robo1.getMovimentos());
                System.out.println("Movimentos do " + robo2.getCor() + "robô normal" + Main.RESET + ": " + robo2.getMovimentos());
                break;
            }
        }
